  ...
  return (
    <>
      <SEO
        ...
        description="Writestream helps you write and publish your content across multiple platforms with ease"
                  ...
                  variants={{
                    ...
                    show: {
                      ...
                      transition: {
                        ...
                        times: [0, 0.1, 0.8, 1],
                        repeat: Infinity,
                        repeatDelay: 11, // Total cycle of 15 seconds (5 items * 3s stagger)
                        ease: "easeInOut"
                      }
                    }
                  }}
